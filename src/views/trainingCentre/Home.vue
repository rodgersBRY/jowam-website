<template>
        ...
        events: [
          {
            ...
            description:
              "Our lead barista @tessthebarista will be competing in the KNBC 18th Edition hosted at TheHub in Karen",
          },
        ],
      };
    },
  ...
  main {
    ...
    .scenic-route {
      margin: 5rem 0;
      background: url("../../assets/coffee-img.jpg");
      background-size: cover;
